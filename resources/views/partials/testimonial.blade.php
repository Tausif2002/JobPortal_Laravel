        ...
        <div class="row align-items-center">
          <div class="col-md-6 mb-5 mb-md-0">
              ...
              <div class="img-border">
                <a href="https://vimeo.com/manage/videos/707655267" class="popup-vimeo image-play">
                  <span class="icon-wrap">
                    <span class="icon icon-play"></span>
                  </span>
                  <img style="background-image: url('external/images/download (2).jpg');" alt="Image" class="img-fluid rounded">
                </a>
              </div>
          ...
          <div class="col-md-5 ml-auto">
            ...
            <p><a href="https://vimeo.com/manage/videos/707655267" class="popup-vimeo text-uppercase">Watch Video <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
      </div>
    </div>
