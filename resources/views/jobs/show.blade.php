...
@section('content')
   <div class="album text-muted">
     <div class="container">
      ...
      <img src="{{asset('external/hero-job-image.jpg')}}" style="width: 100%;">
        ...
        @if(Auth::check()&&Auth::user()->user_type=='seeker')
            ...
            @else
            <centre><span style="color: #000;">You applied this job</span></centre>
            @endif
            </form>
<br>
            <favorite-component :jobid={{$job->id}} :favorited={{$job->checkSaved()?'true':'false'}}  ></favorite-component>
            @else
            Please login as a job seeker to apply this job
...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <p class="badge badge-success">{{$jobRecommendation->job_type}}</p>
